...
# --- ADVANCED CUSTOM CSS (Animated Background, Massive Title & Icon Protection) ---
st.markdown("""
    <style>
    /* 1. Import Custom Tech Font from Google Fonts */
    @import url('https://fonts.googleapis.com/css2?family=Rajdhani:wght@400;500;600;700&display=swap');

    /* 2. Force Rajdhani on EVERY text element for the sleek look */
    ...
    /* 4. Custom App Background (Animated Neural Breathing Effect) */
    .stApp {
...
# ==========================================
    ...
    with tab3:
        ...
        st.dataframe(df[['name', 'category', 'weight', 'active', 'allocated']], use_container_width=True, hide_index=True)import streamlit as st
import pandas as pd
import numpy as np
from sklearn.ensemble import RandomForestRegressor
import plotly.express as px
